 ...
 * @param followLink - boolean, if set to true, tells network abstraction to follow all pagination links and return all results when done.
 * @param callback
 */
...
/**
 * Searches your Okta for a specific user roles
 * @method get
 * @param who search query
 * @param callback
 */
OktaAPIUsers.prototype.getRoles = function(who, callback)
{
    if(who == undefined) throw new Error("A search query is required when trying to get user roles from Okta");
    this.request.get("users/" + who + "/roles", null, callback);
}

/**
 * Searches your Okta for a specific user factors
 * @method get
 * @param who search query
 * @param callback
 */
OktaAPIUsers.prototype.getFactors = function(who, callback)
{
    if(who == undefined) throw new Error("A search query is required when trying to get user factors from Okta");
    this.request.get("users/" + who + "/factors", null, callback);
}
